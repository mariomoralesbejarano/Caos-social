...
export default function PokerCard({ rank, suit, hidden = false, large = false }: {
  ...
  if (hidden || !rank || !suit) {
    return <View style={[styles.card, { width, height }, styles.back]}><Svg width={width - 14} height={height - 14} viewBox="0 0 100 140"><Rect x="4" y="4" width="92" height="132" rx="8" fill="none" stroke="#8fb0d6" strokeWidth="3" /><Path d="m50 22 15 48-15 48-15-48Z" fill="#8fb0d6" opacity=".7" /></Svg></View>;
  }
  const color = SUIT_COLOR[suit];
...
const styles = StyleSheet.create({
  ...
  back: { backgroundColor: "#223553", borderColor: "#8fb0d6" },
